            ...
            <form wire:submit="createForm1" action="" class="main">
                ...
                <div class="mb-3 row" id="section-1">
                    <div class="col">
                        ...
                        <input wire:model.live="title_of_study" value="" type="text" class="form-control" placeholder="">
                ...
                <div class="mb-3 row" id="section-2">
                    ...
                    <div class="form-check">
                        <input wire:click="showQuestion5" wire:model.live="type_of_study" class="form-check-input" id="acRadio" type="radio" value="Academic Staff Study">
                        <label class="form-label-small">
                            Academic Staff Study
                        </label>
                    </div>
                    <div class="form-check">
                        <input wire:click="showQuestion5" wire:model.live="type_of_study" class="form-check-input" type="radio" value="Doctorate Thesis">
                        <label class="form-label-small">
                            Doctorate Thesis
                        </label>
                    </div>
                    <div class="form-check">
                        <input wire:click="showQuestion5" wire:model.live="type_of_study" class="form-check-input" type="radio" value="Master Thesis">
                        <label class="form-label-small">
                            Master Thesis
                        </label>
                    </div>
                    <div class="form-check">
                        <input wire:click="showOtherInput" wire:model.live="type_of_study" class="form-check-input" type="radio" value="other">
                        <label class="form-label-small">
                            Other (Specify):
                        </label>
                    </div>
                    ...
                    <div class="col">
                        <input wire:model.live="type_of_study_other" value="" type="text" class="form-control" placeholder="">
                ...
                <div class="mb-3 row" id="section-3">
                    ...
                    <div class="col">
                        ...
                        <input wire:model.live='researcher_department' type="text" class="form-control" placeholder="">
                        @error('researcher_department')
                        <span class="text-danger">{{ $message }}</span></br>
                        @enderror
                        <label class="form-label-small headers">Institute:</label>
                        <input wire:model.live='researcher_institution' type="text" class="form-control" placeholder="">
                        @error('researcher_institution')
                        <span class="text-danger">{{ $message }}</span></br>
                        @enderror
                        <label class="form-label-small headers">Phone:</label>
                        <input wire:model.live='researcher_phone' type="text" class="form-control" placeholder="+90**********">
                ...
                <div class="mb-3 row" id="section-4">
                    ...
                    <div id="inputContainer1">
                        ...
                        <div class="row">
                            <div class="col">
                                <input wire:model.live="other_researchers.{{ $index }}.name" type="text" class="form-control" placeholder="Name" required>
                            </div>
                            <div class="col">
                                <input wire:model.live="other_researchers.{{ $index }}.institute" type="text" class="form-control" placeholder="Institute" required>
                            </div>
                            <div class="col">
                                <a wire:click.prevent="removeResInput({{ $index }})" class="btn btn-danger removeResInput">Remove</a>
                            </div>
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="mb-3 d-flex flex-wrap row">
                    ...
                    <div class="col-md">
                        ...
                        <select wire:model.live="advisor_title" class="form-select form-select-lg" aria-label=".form-select-lg">
                    ...
                    <div class="col-md">
                        <label class="form-label-small headers">Phone:</label>
                        <input wire:model.live="advisor_phone" type="text" class="form-control" placeholder="+90**********">
                        @error('advisor_phone')
                        <span class="text-danger">This input field is required!</span></br>
                        @enderror

                        <label class="form-label-small headers">Address:</label>
                        <input wire:model.live="advisor_address" type="text" class="form-control" name="Address:">
                        @error('advisor_address')
                        <span class="text-danger">This input field is required!</span></br>
                        @enderror

                        <label class="form-label-small headers">E-mail:</label>
                        <input wire:model.live="advisor_email" type="text" class="form-control" name="E-mail:" placeholder="example@gmail.com">
                        @error('advisor_email')
                        <span class="text-danger">This input field is required!</span></br>
                        @enderror
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md">
                        ...
                        <input wire:model.live='expected_start' class="form-control" type="date" max="2040-12-31" min="1995-01-01">
                    ...
                    <div class="col-md">
                        ...
                        <input wire:model.live='expected_end' class="form-control" type="date" max="2040-12-31" min="1995-01-01">
                        @error('expected_end')
                        <span class="text-danger">{{ $message }}</span></br>
                        @enderror
                    </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div id="inputContainer2">
                        ...
                        <div class="row">
                            <div class="col">
                                <input wire:model.live="organizations.{{ $index }}" type="text" class="form-control" placeholder="" required>
                            </div>
                            <div class="col">
                                <a wire:click.prevent="removeInputOrg({{ $index }})" class="btn btn-danger removeInput">Remove</a>
                            </div>
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="form-check">
                        <input wire:model.live="question_8" value="no" class="form-check-input" type="radio" wire:click="showOtherInput1">
                        <label class="form-label-small" for="flexCheckDefault1">No</label>
                    </div>

                    <div class="form-check">
                        <input wire:model.live="question_8" value="yes" class="form-check-input" type="radio" wire:click="showOtherInput1">
                    ...
                    <div class="col">
                        @if ($question_8 == 'yes')
                        <div class="col">
                            <input wire:model.live="question_8_1" type="text" class="form-control" placeholder="">
                            @error('question_8_1')
                            <span class="text-danger">This input field is required!</span></br>
                            @enderror
                        </div>
                ...
                <div class="mb-3 row">
                    <label for="" class="form-label">9. Whether the project is supported/funded or
                        not:</label>
                    <div class="form-check">
                        <input wire:model.live='question_9' class="form-check-input" value="Supported" type="radio">
                        <label class="form-label-small">Supported</label>
                    </div>
                    <div class="form-check">
                        <input wire:model.live='question_9' class="form-check-input" value="Not Supported" type="radio">
                    ...
                    <div class="form-check">
                        <input wire:click='showOtherInput2' wire:model.live='question_9_1' class="form-check-input" value="University" type="radio">
                        <label class="form-label-small">University</label>
                    </div>
                    <div class="form-check">
                        <input wire:click='showOtherInput2' wire:model.live='question_9_1' class="form-check-input" value="TUBITAK" type="radio">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-check">
                                <label class="form-label-small" for="flexCheckDefault3">International (please
                                    specify)</label>
                                <input wire:click='showOtherInput2' wire:model.live='question_9_1' class="form-check-input" value="international" type="radio">
                            </div>
                            @if ($question_9_1 == 'international')
                            <input wire:model.live="question_9_2" type="text" class="form-control" placeholder="">
                            @error('question_9_2')
                            <span class="text-danger">This input field is required!</span></br>
                            @enderror
                            @endif
                        ...
                        <div class="col">
                            <div class="form-check">
                                ...
                                <input wire:click='showOtherInput2' wire:model.live='question_9_1' class="form-check-input" value="other" type="radio">
                            </div>
                    ...
                    <div class="form-check">
                        <input wire:click='showOtherInput3' wire:model.live='question_9_3' class="form-check-input" type="radio" value="no">
                        <label class="form-label-small">No</label>
                    </div>
                    <div class="form-check">
                        <input wire:click='showOtherInput3' wire:model.live='question_9_3' class="form-check-input" type="radio" value="yes">
                    ...
                    @if ($question_9_3 == 'yes')
                    <div class="col-6">
                        <input wire:model.live="question_9_4" type="text" class="form-control" placeholder="">
                        @error('question_9_4')
                        <span class="text-danger">This input field is required!</span></br>
                        @enderror
                    </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="form-check">
                        <input wire:click='showFields' wire:model.live='status' class="form-check-input" value="New" type="radio">
                        <label class="form-label-small">New</label>
                    </div>
                    <div class="form-check">
                        <input wire:click='showFields' wire:model.live='status' class="form-check-input" value="Revised" type="radio">
                        <label class="form-label-small">Revised</label>
                    </div>


                    <div class="form-check">
                        <input wire:click='showFields' wire:model.live='status' id="rpchanges" class="form-check-input" value="Reporting Changes" type="radio">
                        <label class="form-label-small" for="flexCheckDefault6">Reporting Changes</label>
                    </div>
                    <div class="form-check">
                        <input wire:click='showFields' wire:model.live='status' class="form-check-input" value="Extension of a Previous Study" type="radio">
                ...
                <div class="mb-3 row">
                    <div class="col-6">
                        ...
                        <input wire:model.live='ex_protocol_no' style="width: 50%" type="text" class="form-control" placeholder="">
                    ...
                    <div class="col-6">
                        ...
                        <input wire:model.live='extension_end_date' style="width: 50%" type="date" class="form-control" placeholder="">
                    ...
                    <label class="form-label">If this is an extension of a previous project, does the current study
                        ...
                        approved one?</label>
                    <div class="form-check">
                        <input wire:click='showRpChanges' wire:model.live='extension_q_1' class="form-check-input" type="radio" value="no">
                        <label class="form-label-small">No</label>
                    </div>
                    <div class="form-check">
                        <input wire:click='showRpChanges' wire:model.live='extension_q_1' class="form-check-input" type="radio" value="yes">
                ...
                <div class="mb-3 row">
                    <div class="col">
                        ...
                        <input wire:model.live='rp_protocol_no' style="width: 50%" type="text" class="form-control" placeholder="">
                        ...
                        <div class="form-check">
                            <input wire:model.live='reporting_q_2' class="form-check-input" type="radio" value="no">
                            <label class="form-label-small">No</label>
                        </div>
                        <div class="form-check">
                            <input wire:click='' wire:model.live='reporting_q_2' class="form-check-input" type="radio" value="yes">
                            <label class="form-label-small">Yes</label>
                        </div>
                ...
                <div class="mb-3 row">
                    <div class="col">
                        ...
                        <div class="form-check">
                            <input wire:model.live='question_13' class="form-check-input" type="radio" value="no">
                            <label class="form-label-small" for="flexCheckDefault">No</label>
                        </div>
                        <div class="form-check">
                            <input wire:model.live='question_13' class="form-check-input" type="radio" value="yes">
                ...
                <div class="mb-3 row">
                    <div class="col">
                        <label class="form-label" for="" class="mt-2">14. Beyond the minimum stress and
                            ...
                            them?</label>
                        <div class="form-check">
                            <input wire:model.live='question_14' class="form-check-input" type="radio" value="no">
                            <label class="form-label-small" for="flexCheckDefault">No</label>
                        </div>
                        <div class="form-check">
                            <input wire:model.live='question_14' class="form-check-input" type="radio" value="yes">
                            <label class="form-label-small" for="flexCheckDefault">Yes</label>
                        </div>
                        @error('question_14')
                        <span class="text-danger">This input field is required!</span></br>
                ...
                <div class="mb-3 row">
                    <div class="col">
                        <label class="form-label">15. The expected number of
                            participants:</label>
                        <input wire:model.live='question_15' style="width: 15%" type="number" class="form-control">
                        @error('question_15')
                ...
                <div class="mb-3 row">
                    <div class="col">
                        <label class="form-label">16. If you are doing an education or intervention study, will a
                            ...
                            used?</label>
                        <div class="form-check">
                            <input wire:model.live='question_16' class="form-check-input" type="radio" value="no" name="flexRadioDefault11">
                            <label class="form-label-small" for="flexCheckDefault">No</label>
                        </div>
                        <div class="form-check">
                            <input wire:model.live='question_16' class="form-check-input" type="radio" value="yes" name="flexRadioDefault11">
                            <label class="form-label-small" for="flexCheckDefault">Yes</label>
                        </div>
                        @error('question_16')
                        <span class="text-danger">This input field is required!</span></br>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-check">
                            <input class="form-check-input" wire:model.live='question_17.types.UniversityStudents' type="checkbox" value="University students" id="flexCheckDefault">
                            <label class="form-label-small" for="flexCheckDefault">
                                University students
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" wire:model.live='question_17.types.AdultsInEmployment' type="checkbox" value="Adults in employment" id="flexCheckChecked">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" wire:model.live='question_17.types.UnemployedAdults' type="checkbox" value="Unemployed adults" id="flexCheckDefault">
                            <label class="form-label-small" for="flexCheckDefault">
                                Unemployed adults
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" wire:model.live='question_17.types.PreschoolChildren' type="checkbox" value="Preschool children" id="flexCheckChecked">
                            <label class="form-label-small" for="flexCheckChecked">
                                Preschool children*
                            </label>
                        </div>
                        <div class="form-check">
                            ...
                            <input class="form-check-input" wire:model.live='question_17.types.MentallyDisabledChallengedIndividuals' type="checkbox" value="Mentally disabled/challenged individuals" id="flexCheckDefault">
                        </div>
                        <div class="form-check">
                            <label class="form-label-small">
                                Physically
                            ...
                            <input class="form-check-input" wire:model.live='question_17.types.PhysicallyDisabledChallengedIndividuals' type="checkbox" value="Physically disabled/challenged individuals" id="flexCheckDefault">
                        </div>
                        <br>
                        ...
                        <div class="form-check">
                            <input wire:model.live='question_17_1' class="form-check-input" type="radio" value="no">
                            <label class="form-label-small" for="flexCheckDefault">No</label>
                        </div>
                        <div class="form-check">
                            <input wire:model.live='question_17_1' class="form-check-input" type="radio" value="yes">
                            <label class="form-label-small" for="flexCheckDefault">Yes</label>
                        </div>
                        @error('question_17_1')
                        <span class="text-danger">This input field is required!</span></br>
                    ...
                    <div class="col">
                        <div class="form-check">
                            ...
                            <input style="margin-left: 15px" class="form-check-input" wire:model.live='question_17.types.HighschoolStudents' type="checkbox" value="Highschool students" id="flexCheckDefault">
                            <label class="form-label-small">
                                Highschool
                                students**
                            </label>
                        ...
                        <div class="form-check">
                            <input style="margin-left: 15px" class="form-check-input" wire:model.live='question_17.types.PrimarySchoolPupils' type="checkbox" value="Primary school pupils" id="flexCheckDefault">
                            <label class="form-label-small">
                                Primary school
                                pupils*
                            </label>
                        ...
                        <div class="form-check">
                            ...
                            <input style="margin-left: 15px" class="form-check-input" wire:model.live='question_17.types.ChildWorkers' type="checkbox" value="Child workers" id="flexCheckDefault">
                            <label class="form-label-small">
                                Child workers**
                            </label>
                        </div>
                        <div class="form-check">
                            <input style="margin-left: 15px" class="form-check-input" wire:model.live='question_17.types.TheElderly' type="checkbox" value="The elderly" id="flexCheckDefault">
                            <label class="form-label-small">
                                The elderly
                            </label>
                        </div>
                        <div class="form-check">
                            <input style="margin-left: 15px" class=" form-check-input" wire:model.live='question_17.types.Prisoners' type="checkbox" value="Prisoners" id="flexCheckDefault">
                            <label class="form-label-small">
                                Prisoners
                            </label>
                        </div>
                        <br>
                        <label style="margin-top: 2.6rem;" class="form-label-small">Will you obtain verbal consent from the pupils
                            participating in
                            the
                            study?</label>

                        <div class="form-check">
                            <input wire:model.live='question_17_2' class="form-check-input" type="radio" value="no">
                            <label class="form-label-small" for="flexCheckDefault">No</label>
                        </div>
                        <div class="form-check">
                            <input wire:model.live='question_17_2' class="form-check-input" type="radio" value="yes">
                            <label class="form-label-small" for="flexCheckDefault">Yes</label>
                        </div>
                        @error('question_17_2')
                        <span class="text-danger">This input field is required!</span></br>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input style="width:50%; margin-left:10px;" class="form-control" type="text" wire:model.live='question_17.other'>
                    </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        <div class="form-check">
                            ...
                            <input wire:model.live="question_20.types.Survey" class="form-check-input" type="checkbox" value="Survey" name="methods[]" id="flexCheckSurvey">
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <input wire:model.live="question_20.types.Interview" class="form-check-input" type="checkbox" value="Interview" name="methods[]" id="flexCheckInterview">
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <input wire:model.live="question_20.types.Observation" class="form-check-input" type="checkbox" value="Observation" name="methods[]" id="flexCheckObservation">
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <input wire:model.live="question_20.types.ComputerTest" class="form-check-input" type="checkbox" value="Computer test" name="methods[]" id="flexCheckComputerTest">
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <input wire:model.live="question_20.types.VideoFilmRecording" class="form-check-input" type="checkbox" value="Video/film recording" name="methods[]" id="flexCheckVideoFilmRecording">
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="form-check">
                            ...
                            <input wire:model.live="question_20.types.VoiceRecording" class="form-check-input" type="checkbox" value="Voice recording" name="methods[]" id="flexCheckVoiceRecording">
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <input wire:model.live="question_20.types.PhysiologicalMeasurement" class="form-check-input" type="checkbox" value="Physiological measurement" name="methods[]" id="flexCheckPhysiologicalMeasurement">
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <input wire:model.live="question_20.types.BiologicalSample" class="form-check-input" type="checkbox" value="Biological sample" name="methods[]" id="flexCheckBiologicalSample">
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <input wire:model.live="question_20.types.MakingParticipantsUseSubstance" class="form-check-input" type="checkbox" value="Making participants use alcohol, drugs or any other chemical substance" name="methods[]" id="flexCheckMakingParticipantsUseSubstance">
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <input wire:model.live="question_20.types.ExposureToHighSimulation" class="form-check-input" type="checkbox" value="Exposure to high simulation (such as light, sound)" name="methods[]" id="flexCheckExposureToHighSimulation">
                        </div>
                    </div>
                    ...
                    <input wire:model.live="question_20.other" style="margin-left:10px; width: 50%" class="form-control" type="text" name="methods[other]">
                ...
                <div class="mb-3 row">
                    <div class="col">
                        ...
                        <textarea wire:model.live='question_21' name="possible_contributions" type="text" class="form-control" placeholder="" rows="3"></textarea>
