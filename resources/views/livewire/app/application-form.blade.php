            ...
            <div class="card shadow-sm form">
                ...
                <form wire:submit="createForm1" action="" class="main">
                    ...
                    <div class="mb-3 row" id="section-4">
                        ...
                        <div id="inputContainer1">
                            @foreach ($other_researchers as $index => $researcher)
                                <div class="row">
                                    <div class="col">
                                        <input wire:model.live="other_researchers.{{ $index }}.name"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md">
                            ...
                            <input id="expected_start" wire:model='expected_start' class="form-control"
                                type="date" min="{{ date('Y-m-d', strtotime('+21 days')) }}">
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                ...
                                @if ($reporting_q_2 == 'yes')
                                    <label class="form-label">If your answer is yes; describe the unexpected situation
                                        that
                                        requires you to
                                        make
                    ...
                    @elseif($new_revised)
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                <label class="form-label" for="">11. Please explain the purpose of your study
                                    and
                                    the
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                <label class="form-label" for="" class="mt-2">14. Beyond the minimum stress
                                    and
                                    discomfort that
                                    participants
                                    may encounter
                                    ...
                                    work contain elements that threaten their physical and/or mental health or that may
                                    be a
                                    source
                                    of
                                    stress for
                                ...
                                @enderror
                                @if ($question_14 == 'yes')
                                    <label class="form-label" for="" class="mt-2">If your answer is yes;
                                        what
                                        negative
                                        effects does your
                                        work
                                        ...
                                        physical and/or
                                        mental health of
                                        the participants? Please explain in detail. Please write down the measures taken
                                        in
                                        order to
                                        eliminate or
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                <label class="form-label">16. If you are doing an education or intervention study, will
                                    a
                                    control
                                    group
                                    be
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                <label class="form-label">18. Briefly describe the sample characteristics, special
                                    ...
                                    age group restriction, whether there is a requirement to be a member of a certain
                                    social
                                    group,
                                    etc.) Please
                                    explain.</label>
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                <label class="form-label" for="">19. Explain how you will invite participants
                                    to
                                    the study.
                            ...
                            <div class="col">
                                ...
                                <div class="form-check">
                                    ...
                                    <input wire:model="question_20.types.PhysiologicalMeasurement"
                                        ...
                                        id="flexCheckPhysiologicalMeasurement">
                                </div>
                            ...
                            <p class="">
                                @if (Session::has('success'))
                                    ...
                                    <div class="text-center alert alert-warning">
                                        ...
                                        <p>
                                            Please be aware that in order to complete your application, "Informed
                                            Consent
                                            Form" and "Ethics Committee
                                            Application Control
                                            List" must be filled. Please navigate to the "Informed Consent Form" and
                                            "Application Control List" section
                                            in
                                            the
                                            menu and fill
                                            out the
